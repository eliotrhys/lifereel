        ...
        <section className="" id="faq">
            ...
            <div className="container mx-auto">
                ...
                <div className="w-full lg:w-1/2 mx-auto px-4 lg:px-0">
                    ...
                    <FAQItem question="Can the lifereel include interviews from other family members or friends?" answer="This is definitely possible, though it would mean additional interview and editing fees. If you feel that your loved one&apos;s lifereel would benefit from interviews with other people, email us at hello@lifereel.co.uk, and we&apos;ll talk it through!" />
                    <FAQItem question="Can I request hard copies of the Lifereel for my family members?" answer="Absolutely! While, the digital video file is freely available to view and download at any time, a DVD copy (housed in a premium a wooden case) can be purchased at any time! Just email us at hello@lifereel.co.uk!" />
                    ...
                    <FAQItem question="Is it possible to create a Lifereel for someone who has passed away?" answer="Yes, this is certainly possible. By interviewing you and others who were close to your late loved one, we can create a lifereel to preserve their legacy. Please contact us at hello@lifereel.co.uk if this is something you&apos;d like to discuss." />
