            ...
            <div className="bg-lifereel w-full">
                ...
                <div className="container mx-auto lg:w-full xl:w-3/4 px-4 lg:px-0">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 mb-12">
                        ...
                        <PricingItem title="Basic Lifereel" image={tierTwo.src} icon="📽️" description="Our full lifereel service, featuring a beautiful 30-minute film, overlayed with photographs, home movies & music" price={3995} offerPrice={1599} features={["Netflix quality 2-camera interview", "Photo scanning, retouching and restoration", "Home movie digitisation", "3 rounds of revisions", "Beautiful shareable video page to view your lifereel (& digital download)", "Hard drive containing all digitised photographs and home movies, as well as the raw, unedited interview footage"]} />
