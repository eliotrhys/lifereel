            ...
            <div className="bg-lifereel w-full">
                ...
                <div className="container mx-auto lg:w-full xl:w-3/4 px-4 lg:px-0">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 mb-12">
                        ...
                        <PricingItem title="Basic Interview" image={tierOne} icon="👍" description="A simple, beautifully composed interview in your loved one's home" price={795} features={["Netflix quality 2-camera interview", "Assistance in drawing up interview questions to ensure a comprehensive overview of your loved one's life story", "Hard drive containing the raw, unedited interview footage"]} />
                        <PricingItem title="Basic Lifereel" image={tierTwo} icon="📽️" description="Our full lifereel service, featuring a beautiful 30-minute film, overlayed with photographs, home movies & music" price={3995} offerPrice={1599} features={["Netflix quality 2-camera interview", "Photo scanning, retouching and restoration", "Home movie digitisation", "3 rounds of revisions", "Beautiful shareable video page to view your lifereel (& digital download)", "Hard drive containing all digitised photographs and home movies, as well as the raw, unedited interview footage"]} />
                        <PricingItem title="Premium Lifereel" image={tierThree} icon="🤩" description="Our premium lifereel solution, including a beautiful 30+ minute film, additional filming, hard copies in a premium wooden case, and more!" price={5995} offerPrice={2399} features={["Netflix quality 2-camera interview", "Comprehensive scan of your entire photograph collection", "Home movie digitisation", "Additional footage capture (B-Roll) of your loved one, plus additional interviews (if needed)", "Unlimited revisions", "Shareable video page to view your lifereel (& digital download)", "2x Shareable highlight reels to post on social media or send to friends", "DVD in premium wooden case", "Hard drive containing all digitised photographs and home movies, as well as the raw, unedited interview footage"]} isPremium={true} />
