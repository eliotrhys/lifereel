            ...
            <div className="container mx-auto lg:w-2/3 bg-slate-800 rounded-lg">
                <div className="grid xl:grid-cols-2">
                    ...
                    <div className="p-10 xl:p-6 text-cream">
                        ...
                        <div className="">
                            <a href="https://www.skool.com/lifereel/about" target="_blank" className="button-lifereel w-full lg:w-auto p-4 px-12 rounded-lg inline-block font-medium text-lg duration-300 ease-in-out text-center">Learn more!</a>
                        </div>
                    </div>
                </div>
            </div>
