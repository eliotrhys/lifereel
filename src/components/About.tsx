    ...
    return (
        <section className="relative" id="about">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 -top-16">
                <img src={scratch.src} className="h-32" alt="" />
            </div>
                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-2 gap-14">
                        ...
                        <div className="">
                            ...
                            <ul className="mb-14 grid grid-cols-2 gap-4">
                                <li className="m-2 text-lg font-medium leading-relaxed border border-amber-200 bg-amber-100 rounded-lg flex items-center min-w-[80px]">
                                    <span className="p-4 border-r border-amber-200 flex items-center text-5xl h-full">👴🏻</span>
                                    <span className="p-4 text-amber-900">15+ years filmmaking experience</span>
                                </li>
                                <li className="m-2 text-lg font-medium leading-relaxed border border-amber-200 bg-amber-100 rounded-lg flex items-center min-w-[80px]">
                                    <span className="p-4 border-r border-amber-200 flex items-center text-5xl h-full">🎓</span>
                                ...
                                <li className="m-2 text-lg font-medium leading-relaxed border border-amber-200 bg-amber-100 rounded-lg flex items-center min-w-[80px]">
                                    <span className="p-4 border-r border-amber-200 flex items-center text-5xl h-full">🏆</span>
                                    <span className="p-4 text-amber-900">Award-winning short film director</span>
                                </li>
                                <li className="m-2 text-lg font-medium leading-relaxed border border-amber-200 bg-amber-100 rounded-lg flex items-center min-w-[80px]">
                                    <span className="p-4 border-r border-amber-200 flex items-center text-5xl h-full">🇬🇧</span>
                                    <span className="p-4 text-amber-900">Worked with some of the UK's biggest brands</span>
                                </li>
                            </ul>
