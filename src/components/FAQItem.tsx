...
const FAQItem = (props: FAQItemProps) => {
    ...
    return (
        <div className="border-b-2 border-black py-8 w-full">
            <div onClick={toggleAnswer} className="flex items-center justify-between text-lg lg:text-xl font-medium cursor-pointer">
            ...
            {showAnswer && <div className="text-lg mt-8">{props.answer}</div>}
